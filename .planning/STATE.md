...
- [v10.1-roadmap]: **JC-02 ppm-axis correctness is the milestone's one real technical risk**, flagged for extra verification emphasis in Phase 101 — same defect class as v10.0's WR-04 (Bruker OFFSET treated as Hz). Must be checked against the trusted 1D reference / the §10 shift list, not eyeballed (⚠ corrected 2026-07-31: §10 is a prior agent's hypothesis about the unsolved sample, NOT ground truth — it cross-checks the ppm axis across two readers, nothing more; PROV-01); carried as an explicit success-criterion clause, not folded silently into JC-01.
