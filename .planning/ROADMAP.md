...
- [ ] 99-01-PLAN.md — Nyquist Wave 0: QcVerdict/QcCheckResult/QcReport models + known-bad & synthetic-clean fixtures + RED-by-skip stubs (wave 1)
- [ ] 99-02-PLAN.md — nus/qc.py: 6 checks + aggregate_verdict + run_qc_checks + 3-tier prot/quaternary resolver (QC-01/QC-02, wave 2)
- [ ] 99-03-PLAN.md — nus/bridge.py: Spectrum2D→PeakPicker2D bridge + per-experiment schema + metadata block + shared edited-sign helper (PICK-01/PICK-03, wave 2)
...
| 99. Peak-Pick Bridge + QC Gate + CLI | 0/4 | Planned     | - |
