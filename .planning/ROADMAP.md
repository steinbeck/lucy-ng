...
- [ ] 97-01-PLAN.md — Fixtures + NusAcquisitionParams/NusSchedule Pydantic contracts + package skeleton (wave 1)
- [ ] 97-02-PLAN.md — nus/params.py acqus/acqu2s/procs/proc2s extraction (NUS-02, wave 2)
...
|-------|-----------------|--------|-----------|
| 97. Backend Integration + Params/Schedule | 0/5 | Not started | - |
