...
The calibration anchor for the whole QC gate (D-02/D-04): the real
known-bad home-IST HSQC/HMBC/COSY lists MUST verdict FAIL (via the
critical quaternary-exclusion + signal-to-ridge checks); the
